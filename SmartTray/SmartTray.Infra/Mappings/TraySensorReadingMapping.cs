...
namespace SmartTray.Infra.Mappings
{
    public class TraySensorReadingMapping : IEntityTypeConfiguration<TraySensorReading>
    {
        public void Configure(EntityTypeBuilder<TraySensorReading> builder)
        {
            ...
            builder.Property(t => t.Temperature).IsRequired().HasColumnName("temperature_celsius");
            builder.Property(h => h.Humidity).IsRequired().HasColumnName("humidity");
            builder.Property(u => u.UV).IsRequired().HasColumnName("uv");
