...
namespace SmartTray.Infra.Migrations
{
    ...
    [Migration("20250703145407_InsertUserEntityAndCreateMappings")]
    partial class InsertUserEntityAndCreateMappings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartTray.Domain.Models.Tray", b =>
                {
                    ...
                    b.HasOne("SmartTray.Domain.Models.TraySettings", "Settings")
                        .WithOne("Tray")
                        .HasForeignKey("SmartTray.Domain.Models.Tray", "tray_id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
